...
first_female = read_list("/home/user/lab25/name-first-female.txt"); name_case(first_female)
first_male = read_list("/home/user/lab25/name-first-male.txt"); name_case(first_male)
last_all = read_list("/home/user/lab25/name-last-all.txt"); name_case(last_all)
